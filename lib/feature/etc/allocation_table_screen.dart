...
class _AllocationTableScreen extends ConsumerState<AllocationTableScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: const ScrollablePinchView(
            child: Padding(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      AllocationSection(title: '신입회원 증가', content: [
                        IndexTitle('● 입회 날짜별 점수 차등 및 가산점 부여',
                            textColor: GlobalColor.darkGreyFontColor),
                        IndexMinText(
                      ...
                      AllocationSection(title: '내 로타리 계정 만들기', content: [
                        Text('● 100점',
                            style: TextStyle(
                                ...
                                fontWeight: FontWeight.bold,
                                color: GlobalColor.darkGreyFontColor)),
                        Text('전회원의 80% 이상 로타리 웹사이트 "내 로타" \n계정 만들기 완료',
                            style: TextStyle(
                                fontSize: 16,
                                color: GlobalColor.darkGreyFontColor))
                      ]),
                      AllocationSection(title: '사진콘테스트 출품 참여', content: [
                        Text('● 10점',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                      ...
                      AllocationSection(title: '총재월신, 로타리코리아지 책자비치', content: [
                        Text('● 1회/20점',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: GlobalColor.darkGreyFontColor)),
                        Text('공공기관 내 총재월신, 로타리코리아지 비치 할 시 (인증샷 필수) / 최대 10회',
                            style: TextStyle(
                                fontSize: 16,
                                color: GlobalColor.darkGreyFontColor))
                      ]),
                      AllocationSection(title: '로타리 회원의 집 신청', content: [
                        Text('● 15점',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: GlobalColor.darkGreyFontColor)),
                        Text('로타리 회원의 집 명판 달기 참여 업체 1개당 15점',
                            style: TextStyle(
                                fontSize: 16,
                                color: GlobalColor.darkGreyFontColor))
                      ]),
                      AllocationSection(title: '로타리 제휴(대구은행) 희망카드발급', content: [
                        Text('● 기업신용카드 발급 1개당 15점 / 개인신용카드 1개당 10점',
                            style: TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: GlobalColor.darkGreyFontColor))
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Container(
          ...
          child: IndexTitle(title, textColor: GlobalColor.white)),
      ...
      Container(
          ...
          child: Padding(
              ...
              child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: content
                      .expand((widget) => [const SizedBox(height: 10), widget])
                      .toList()))),
