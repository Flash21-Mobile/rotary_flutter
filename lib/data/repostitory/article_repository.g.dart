...
class _ArticleRepository implements ArticleRepository {
  ...
  Future<List<ArticleModel>> getArticle({
    ...
    final _options = _setStreamType<List<ArticleModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<ArticleModel> postArticle(ArticleModel data) async {
    ...
    final _options = _setStreamType<ArticleModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late ArticleModel _value;
    try {
      _value = ArticleModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<List<ArticleModel>> getArticleRandom() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
